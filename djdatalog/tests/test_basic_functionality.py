"""
Basic functionality tests for djdatalog without database dependencies.
"""
...
from djdatalog.models import Var, _fact_to_django_query


class BasicFunctionalityTests(TestCase):
    """Test basic djdatalog functionality."""
